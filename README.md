...
* No Maven artifacts were used (required libraries are enclosed in lib folder). JavaFX library must be properly configured in your IDE to run the program (minimum requirement = SDK v19).
